...
public class CurrentPhoneLocation extends AppCompatActivity{
    ...
    public CurrentPhoneLocation(final Context context) {
        this.context=context;
    }
    public LatLng refreshedLocation(){
        ...
        callback = new LocationCallback(){
            ...
            public void onLocationResult(LocationResult locationResult) {
                for(Location location : locationResult.getLocations()){
                    ...
                    latLngRef=new LatLng(latitude,longitude);
